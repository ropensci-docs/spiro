# Contributing to the spiro package
...
Think spiro is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using spiro for a paper you are writing? Retrieve all citation
information by running `citation("spiro")` in the R console.

### Ask a question

Using spiro and got stuck? Browse the
[documentation](https://docs.ropensci.org/spiro/) to see if you can find
a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/ropensci/spiro/issues).

Want to ask a question in private? Contact the package maintainer by
[mail](mailto:s.nolte@dshs-koeln.de).

### Propose an idea

Have an idea for a new spiro feature? Take a look at the
[documentation](https://docs.ropensci.org/spiro/) and [issue
list](https://github.com/ropensci/spiro/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/ropensci/spiro/issues). While we can’t
...
Do you want your metabolic cart to be supported by the spiro package?
Consider sending me example raw data files via
[mail](mailto:s.nolte@dshs-koeln.de).

### Report a bug

Using spiro and discovered a bug? That’s annoying! Don’t let others have
the same experience and report it as an [issue on
GitHub](https://github.com/ropensci/spiro/issues) so we can fix it. A
...
[This website](https://docs.ropensci.org/spiro/) is generated with
...
issue](https://github.com/ropensci/spiro/issues) and we can point you in
the right direction.
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/ropensci/spiro).
...
Care to fix bugs or implement new functionality for spiro? Awesome! Have
a look at the [issue list](https://github.com/ropensci/spiro/issues) and
...
1.  Fork [this repo](https://github.com/ropensci/spiro) and clone it to
